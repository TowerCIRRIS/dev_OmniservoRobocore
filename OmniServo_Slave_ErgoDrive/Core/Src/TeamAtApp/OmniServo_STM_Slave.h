 ...
 * \author Simon latour ( based of code by Nicolas Breton (nibre28))
 * \version 2.0
 * \date 2025-11-21
 */

#ifndef OMNISERVO_STM_SLAVE_H
#define OMNISERVO_STM_SLAVE_H
...
#define DEFAULT_MAX_ACCELERATION           1000.0  // deg/s^2
#define DEFAULT_POSITION_DEADBAND          0.6     // deg
...
#define DEFAULT_POSITION_STALL_TIMEOUT     5.0     // s
...
private:
    ...
    int32_t m_originRef = 0;
    int8_t m_refDirection = 0;
    int32_t m_nbCurrentTurns = 0.0f;
    float m_centerReadAngle = 0.0f;
    float m_torqueConstant = 0.0f;
    ...
    float m_driveCommand= 0.0f;

    float m_previousReadAngle= 0.0f;
    float m_previousSpeed= 0.0f;
    float m_previousAngle10Hz= 0.0f;
